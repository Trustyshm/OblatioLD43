...
public class Item : ScriptableObject
{
    ...
    private GameObject eatingSound;
    private AudioSource eatingNow;
    ...
    public virtual void Use()
    {
        ...
        if (animalFood)
        {
            ...
            eatingSound = GameObject.FindGameObjectWithTag("Eating");
            eatingNow = eatingSound.GetComponent<AudioSource>();
            Debug.Log(eatingSound.name);
